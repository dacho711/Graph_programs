...
def create_l9_final_report_plot(csv_file=r"C:\Users\dacho\Documents\研究室\git用\Graph_programs\Ra_calculater\youin_arasa_20_japanese.csv"):
    try:
    ...
    for f in factors_data:
        ...
        # 折れ線プロット
        plt.plot(x_points, y_points, marker='o', ms=10, mfc="#15571d", color='#15571d', linewidth=2.5, zorder=3)
