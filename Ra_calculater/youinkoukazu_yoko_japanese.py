...
def create_l9_final_report_plot(csv_file=r"C:\Users\dacho\Documents\研究室\git用\Graph_programs\Ra_calculater\yoko_youin_japanse.csv"):
    try:
    ...
    labels = [30, 40, 50, 50, 75, 100, 0.97, 1.00, 1.03]#造形速度, ファン風量，流量比
    label_idx = 0
    ...
    for f in factors_data:
        ...
        # 折れ線プロット
        plt.plot(x_points, y_points, marker='o', ms=10, mfc="#2a0d95", color='#2a0d95', linewidth=2.5, zorder=3)
